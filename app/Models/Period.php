...
class Period extends Model
{
    protected $fillable = [
        ...
        'is_discounted', 'combine_group', 'room_tariff_id', 'villa_tariff_id', 'is_open', 'note',
    ];
    ...
    /**
     * "Birleşen Devreler": yalnızca aynı grup içindeki, numarası bir sonraki olan devre
     * ile birleştirilebilir (Madde 5/7 — ardışık en fazla iki devre).
     */
    public function canCombineWith(Period $other): bool
    {
        return $this->combine_group !== null
            && $this->facility_id === $other->facility_id
            && $this->year === $other->year
            && $this->combine_group === $other->combine_group
            && $other->number === $this->number + 1;
    }
