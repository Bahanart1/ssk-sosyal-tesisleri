<x-layouts.guest title="Admin Girişi">
    <div class="mb-8">
        ...
        <h1 class="mt-2 font-display text-3xl font-semibold tracking-tight text-ink">Yönetici girişi</h1>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" @click="showPass = !showPass"
                        class="absolute inset-y-0 right-0 flex items-center px-3 text-ink-subtle hover:text-ink"
    ...
    <p class="mt-8 text-center text-sm text-ink-muted">
        Müşteri misiniz?
        <a href="{{ route('login') }}" class="font-semibold text-ink underline decoration-accent-400 underline-offset-4 hover:text-accent-700 dark:hover:text-accent-300">Müşteri girişi</a>
    </p>
</x-layouts.guest>
