@if (session('success') || session('error'))
    ...
    >
        @if (session('success'))
            <div class="flex items-start gap-3 rounded-xl2 border border-emerald-100 bg-white/95 px-4 py-3.5 shadow-lift backdrop-blur">
        ...
        @endif
        @if (session('error'))
            <div class="flex items-start gap-3 rounded-xl2 border border-red-100 bg-white/95 px-4 py-3.5 shadow-lift backdrop-blur">
